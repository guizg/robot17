...
while(True):
    ...
    if circles != None:
        ...
        if len(Ycentros) == 3:
            ...
            l3 =Ycentros[1]-Ycentros[0]
            lx = Xcentros[2]-Xcentros[0] 
            lx2 = Xcentros[2]-Xcentros[1]
            lx3 = Xcentros[1]-Xcentros[0]
                
            if (raio[0]==raio[1] and raio[0]==raio[2]):
                ...
                #print "maiorY = "+ str(maiorY)
                #print "maiorX = "+ str(maiorX)
        
                if maiorY<maiorX:
                    print "Vertical"
                    #text = "Vertical"
                    #font = cv2.FONT_HERSHEY_SIMPLEX
                    #cv2.putText(bordas_color,'Horizontal',(0,50), font, 2,(255,255,255),2,cv2.CV_AA,(0,0))
                else:
                    print "Horizontal"
                    #text = "Horizontal"
                    #font = cv2.FONT_HERSHEY_SIMPLEX
                    #cv2.putText(bordas_color,'Vertical',(0,50), font, 2,(255,255,255),2,cv2.CV_AA,(0,0))
                print "Distancia = "+str(dist)
                #font = cv2.FONT_HERSHEY_SIMPLEX
                #cv2.putText(bordas_color,"{0}".format(dist),(0,50), font, 2,(255,255,255),2,cv2.CV_AA,(0,75))
    ...
    #font = cv2.FONT_HERSHEY_SIMPLEX
    #cv2.putText(bordas_color,text,(0,50), font, 2,(0,255,0),2,cv2.CV_AA)
